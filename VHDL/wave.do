...
add wave -noupdate -format Literal /testbench/memory/mem_core/data
add wave -noupdate -format Literal /testbench/wbo/yot2/data
add wave -noupdate -format Literal /testbench/mydata
add wave -noupdate -format Logic /testbench/clk_i
add wave -noupdate -format Logic /testbench/reset
add wave -noupdate -format Logic /testbench/int
add wave -noupdate -format Logic /testbench/halt
add wave -noupdate -format Logic /testbench/flag
add wave -noupdate -format Literal /testbench/q_pc
add wave -noupdate -format Literal /testbench/q_opc
add wave -noupdate -format Literal /testbench/q_imm
add wave -noupdate -format Literal /testbench/q_cyc
add wave -noupdate -format Logic /testbench/q_we_rr
add wave -noupdate -format Logic /testbench/q_we_ll
add wave -noupdate -format Literal /testbench/q_we_sp
add wave -noupdate -format Literal /testbench/q_cat
...
add wave -noupdate -format Logic /testbench/acki_proc
add wave -noupdate -format Logic /testbench/cyco_proc
add wave -noupdate -format Logic /testbench/stbo_proc
...
WaveRestoreCursors {{Cursor 1} {67500 ns} 0}
...
update
WaveRestoreZoom {2120 ns} {2596 ns}
