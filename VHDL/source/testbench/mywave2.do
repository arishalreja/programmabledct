...
add wave -noupdate -format Logic -radix hexadecimal /tb_mdct/wbo/yot1/odv2_s
add wave -noupdate -format Literal -radix hexadecimal /tb_mdct/wbo/yot1/dcto2_s
add wave -noupdate -format Logic -radix hexadecimal /tb_mdct/wbo/yot1/trigger2_s
add wave -noupdate -format Logic -radix hexadecimal /tb_mdct/wbo/yot1/trigger1_s
add wave -noupdate -format Literal -radix hexadecimal /tb_mdct/wbo/yot1/ramdatao1_s
add wave -noupdate -format Literal -radix hexadecimal /tb_mdct/wbo/yot1/ramdatao2_s
add wave -noupdate -format Logic -radix hexadecimal /tb_mdct/wbo/yot1/ramwe1_s
add wave -noupdate -format Logic -radix hexadecimal /tb_mdct/wbo/yot1/ramwe2_s
add wave -noupdate -format Logic -radix hexadecimal /tb_mdct/wbo/yot1/memswitchrd_s
add wave -noupdate -format Logic -radix hexadecimal /tb_mdct/wbo/yot1/memswitchwr_s
add wave -noupdate -format Logic -radix hexadecimal /tb_mdct/wbo/yot1/wmemsel_s
add wave -noupdate -format Logic -radix hexadecimal /tb_mdct/wbo/yot1/rmemsel_s
add wave -noupdate -format Logic -radix hexadecimal /tb_mdct/wbo/yot1/dataready_s
add wave -noupdate -format Logic -radix hexadecimal /tb_mdct/wbo/yot1/datareadyack_s
add wave -noupdate -format Literal -radix hexadecimal /tb_mdct/wbo/yot2/add_width
add wave -noupdate -format Literal -radix hexadecimal /tb_mdct/wbo/yot2/width
add wave -noupdate -format Literal -radix hexadecimal /tb_mdct/wbo/yot2/data_out_width
add wave -noupdate -format Logic -radix hexadecimal /tb_mdct/wbo/yot2/clk
add wave -noupdate -format Logic -radix hexadecimal /tb_mdct/wbo/yot2/reset
...
add wave -noupdate -format Literal -radix hexadecimal /tb_mdct/wbo/yot2/data
add wave -noupdate -format Logic -radix hexadecimal /tb_mdct/wbo/yot2/flag
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {5019746 ps} 0}
...
update
WaveRestoreZoom {1870682 ps} {5585754 ps}
